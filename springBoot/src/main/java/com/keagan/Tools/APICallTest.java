...
public class APICallTest {
    ...
    public static void call_me() throws Exception {
        ...
        String APIkey = "6bbc6f30-0a42-446f-80ef-1b29324a15c0";
        String PageID = "v4xyzf5fwkky";
        String url = "https://api.statuspage.io/v1/pages/v4xyzf5fwkky.json?api_key=6bbc6f30-0a42-446f-80ef-1b29324a15c0";
